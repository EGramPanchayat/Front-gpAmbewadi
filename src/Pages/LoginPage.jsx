    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 px-4">
      ...
      <div className="flex flex-col md:flex-row w-full max-w-4xl h-auto md:h-[400px] bg-white shadow-2xl rounded-2xl overflow-hidden">
        ...
        <div className="relative w-full md:w-1/2 h-48 md:h-auto">
          ...
          />
          <h1 className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-2/11 text-2xl md:text-4xl font-extrabold text-green-200 drop-shadow-lg font-serif text-center">
