...
const stats = [
  { icon: "🌾", number: "1007", label: "हेक्टर क्षेत्रफळ" },
  { icon: "🏘", number: "3", label: "वार्ड संख्या" },
  { icon: "👥", number: "928", label: "एकूण लोकसंख्या" },
  { icon: "🏠", number: "280", label: "कुटुंब संख्या" },
];
        ...
        <div className="max-w-8xl w-full flex flex-col items-center">
          ...
          <div className="bg-white  rounded-xl shadow-lg p-4 sm:p-8 mb-4 sm:mb-8 hover:shadow-2xl hover:-translate-y-1 transition">
            ...
            <p className="text-lg text-justify leading-relaxed">
              आंबेवाडी हे <span className="text-orange-500 font-semibold">महाराष्ट्र राज्यातील सांगली जिल्ह्यातील आटपाडी तालुक्यातील</span> एक प्रगतशील गाव आहे. २०११ च्या जनगणनेनुसार या गावाची लोकसंख्या सुमारे <span className="text-orange-500 font-semibold">928</span> आहे.
              गावामध्ये जिल्हा परिषद प्राथमिक शाळा 1, अंगणवाडी केंद्रे 1, माध्यमिक विद्यालय 0, वाचनालय 1, व्यायामशाळा 1 अशी शैक्षणिक व शारीरिक सुविधा उपलब्ध आहेत.
              तसेच गावातील <span className="text-orange-500 font-semibold">मारुती मंदिर</span> हे प्रसिद्ध देवस्थान आहे.
            </p>
            <p className="text-lg text-justify leading-relaxed mt-4">
              गावातील बहुतांश लोकांचा मुख्य व्यवसाय <span className="text-orange-500 font-semibold">शेती</span> असून अधिकतर <span className="text-orange-500 font-semibold">बाजरी ,मका ,डाळिंब </span> ही प्रमुख पिके घेतली जातात.
              डाळिंब या पिकाच्या लागवडीमुळे गावातील शेतकऱ्यांना चांगले उत्पन्न मिळते.
              आंबेवाडी ग्रामपंचायतीत विविध शासकीय योजना प्रभावीपणे राबविल्या गेल्या आहेत.
              <span className="text-orange-500 font-semibold">स्वच्छ भारत अभियान</span> अंतर्गत आंबेवाडी गावाने संपूर्ण
