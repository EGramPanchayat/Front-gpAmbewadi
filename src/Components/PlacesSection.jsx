    ...
    <div className="max-w-6xl mx-auto px-4 flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-4 fade-in flex flex-col justify-between items-center h-full hover:shadow-2xl hover:-translate-y-1 transition">
          <img src="./images/maruti.jpg" alt="गणपती मंदिर" className="w-full h-48 object-cover rounded-xl mb-4" />
          <h5 className="text-lg font-bold mb-2 flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M12 2L12 22"/><path d="M6 12L12 2L18 12"/></svg>मारुती मंदिर</h5>
          <p className="text-justify">गावाचे ग्रामदैवत असलेले मारुती मंदिर गावकऱ्यांचे प्रमुख श्रद्धास्थान आहे. मंदिर आंबेवाडी गावाच्या मध्यभागी, मुख्य रस्त्याजवळ स्थित असल्यामुळे भाविकांसाठी ते सहज उपलब्ध आहे.</p>
        </div>
        {/* पाझर तलाव */}
        <div className="bg-white rounded-xl shadow-lg p-4 fade-in flex flex-col justify-between items-center h-full hover:shadow-2xl hover:-translate-y-1 transition">
