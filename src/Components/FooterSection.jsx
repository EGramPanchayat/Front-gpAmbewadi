      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-8">
          <div className="flex-1 mb-6 md:mb-0">
            <h5 className="mb-3 flex items-center gap-2 font-bold text-xl"><svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"><rect x="4" y="8" width="16" height="8" rx="2"/></svg>ग्रामपंचायत आंबेवाडी</h5>
          ...
          <div className="flex-1 mb-6 md:mb-0">
            ...
            <ul className="space-y-2 text-base">
              <li className="flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><rect x="2" y="7" width="20" height="10" rx="2" /><polyline points="2,7 12,13 22,7" /></svg>gpambewadi1992@gmail.com</li>
